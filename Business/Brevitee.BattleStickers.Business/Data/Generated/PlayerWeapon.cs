...
namespace Brevitee.BattleStickers.Business.Data
{
	...
	public Weapon WeaponOfWeaponId
	{
		...
		public static PlayerWeaponCollection LoadAll(Database database = null)
		{
			...
			Database db = database == null ? Db.For<PlayerWeapon>(): database;
		...
		{
			var results = new PlayerWeaponCollection(db, new Query<PlayerWeaponColumns, PlayerWeapon>(where, db), true);
			return results;
		}
		...
		{
			var results = new PlayerWeaponCollection(db, new Query<PlayerWeaponColumns, PlayerWeapon>(where, orderBy, db), true);
			return results;
		}
		...
		{
			var results = new PlayerWeaponCollection(db, Select<PlayerWeaponColumns>.From<PlayerWeapon>().Where(where, db));
			return results;
		}
