...
namespace Brevitee.BattleStickers.Business.Data
{
	...
	public Character CharacterOfCharacterId
	{
		...
		public static PlayerTwoCharacterCollection LoadAll(Database database = null)
		{
			...
			Database db = database == null ? Db.For<PlayerTwoCharacter>(): database;
		...
		{
			var results = new PlayerTwoCharacterCollection(db, new Query<PlayerTwoCharacterColumns, PlayerTwoCharacter>(where, db), true);
			return results;
		}
		...
		{
			var results = new PlayerTwoCharacterCollection(db, new Query<PlayerTwoCharacterColumns, PlayerTwoCharacter>(where, orderBy, db), true);
			return results;
		}
		...
		{
			var results = new PlayerTwoCharacterCollection(db, Select<PlayerTwoCharacterColumns>.From<PlayerTwoCharacter>().Where(where, db));
			return results;
		}
