...
{
    public class BreviteeContinuousIntegrationJobConf: ContinuousIntegrationJobConf, IHasRequiredProperties
    {
        public BreviteeContinuousIntegrationJobConf(string name = "GitContinuousIntegration")
            : base(name)
        {
