...
namespace Brevitee.StickerHeroes
{
	...
	public Equipment EquipmentOfEquipmentId
	{
		...
		{
			return new PlayerTwoEquipmentCollection(new Query<PlayerTwoEquipmentColumns, PlayerTwoEquipment>(where, db), true);
		}
		...
		{
			return new PlayerTwoEquipmentCollection(new Query<PlayerTwoEquipmentColumns, PlayerTwoEquipment>(where, orderBy, db), true);
		}
		...
		{
			return new PlayerTwoEquipmentCollection(Select<PlayerTwoEquipmentColumns>.From<PlayerTwoEquipment>().Where(where, db));
		}
		...
		{
			var results = new PlayerTwoEquipmentCollection(Select<PlayerTwoEquipmentColumns>.From<PlayerTwoEquipment>().Where(where, db));
		...
		public static PlayerTwoEquipmentCollection Top(int count, WhereDelegate<PlayerTwoEquipmentColumns> where, OrderBy<PlayerTwoEquipmentColumns> orderBy, Database database = null)
		{
			...
			Database db = database == null ? _.Db.For<PlayerTwoEquipment>(): database;
			...
			query.Execute(db);
			return query.Results.As<PlayerTwoEquipmentCollection>(0);
		}
