...
namespace Brevitee.Analytics.Classification
{
	...
	[Brevitee.Data.Column(Name="FeatureToCategoryCount", ExtractedType="BigInt", MaxLength="8", AllowNull=false)]
	...
	public Category CategoryOfCategoryId
	{
		get
		{
			...
			{
				_categoryOfCategoryId = Brevitee.Analytics.Classification.Category.OneWhere(f => f.Id == this.CategoryId);
			}
