...
namespace Brevitee.StickerHeroes
{
	...
	public Weapon WeaponOfWeaponId
	{
		...
		{
			return new PlayerTwoWeaponCollection(new Query<PlayerTwoWeaponColumns, PlayerTwoWeapon>(where, db), true);
		}
		...
		{
			return new PlayerTwoWeaponCollection(new Query<PlayerTwoWeaponColumns, PlayerTwoWeapon>(where, orderBy, db), true);
		}
		...
		{
			return new PlayerTwoWeaponCollection(Select<PlayerTwoWeaponColumns>.From<PlayerTwoWeapon>().Where(where, db));
		}
		...
		{
			var results = new PlayerTwoWeaponCollection(Select<PlayerTwoWeaponColumns>.From<PlayerTwoWeapon>().Where(where, db));
		...
		public static PlayerTwoWeaponCollection Top(int count, WhereDelegate<PlayerTwoWeaponColumns> where, OrderBy<PlayerTwoWeaponColumns> orderBy, Database database = null)
		{
			...
			Database db = database == null ? _.Db.For<PlayerTwoWeapon>(): database;
			...
			query.Execute(db);
			return query.Results.As<PlayerTwoWeaponCollection>(0);
		}
