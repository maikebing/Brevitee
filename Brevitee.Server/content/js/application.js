    ...
    function _loadPages(subAppName, startPageName) {
        ...
        return _.act("bam", "getpages", { bamAppName: subAppName }).done(function (result) {
            if (result.Success) {
                ...
                .then(function(){
                    app.createPageTransition(startPageName + "To" + startPageName, startPageName, startPageName, app.defaultPageTransitionHandler);
    ...
    function activate(page, d) {
        ...
        b.promise(function(){
                ...
                if (_.isFunction(app.pageActivationHandlers[page.name])) {
                    ...
                    _.each(app.pageActivationHandlers, function(fn){
                       fn(page, d);
                    });
                }
