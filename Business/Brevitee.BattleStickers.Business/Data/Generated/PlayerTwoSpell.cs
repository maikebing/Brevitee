...
namespace Brevitee.BattleStickers.Business.Data
{
	...
	public Spell SpellOfSpellId
	{
		...
		public static PlayerTwoSpellCollection LoadAll(Database database = null)
		{
			...
			Database db = database == null ? Db.For<PlayerTwoSpell>(): database;
		...
		{
			var results = new PlayerTwoSpellCollection(db, new Query<PlayerTwoSpellColumns, PlayerTwoSpell>(where, db), true);
			return results;
		}
		...
		{
			var results = new PlayerTwoSpellCollection(db, new Query<PlayerTwoSpellColumns, PlayerTwoSpell>(where, orderBy, db), true);
			return results;
		}
		...
		{
			var results = new PlayerTwoSpellCollection(db, Select<PlayerTwoSpellColumns>.From<PlayerTwoSpell>().Where(where, db));
			return results;
		}
