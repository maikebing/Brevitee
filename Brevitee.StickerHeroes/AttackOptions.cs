...
namespace Brevitee.StickerHeroes
{
    public class AttackOptions
    {
        ...
        public AttackOptions()
        {
            ...
            {
                return (IAttackMethod)Brevitee.StickerHeroes.Weapon.OneWhere(c => c.Id == Weapon);
            };
            this._attackMethodResolvers[AttackType.Spell] = () =>
            {
                return (IAttackMethod)Brevitee.StickerHeroes.Spell.OneWhere(c => c.Id == Spell);
            };
            this._attackMethodResolvers[AttackType.Skill] = () =>
            {
                return (IAttackMethod)Brevitee.StickerHeroes.Skill.OneWhere(c => c.Id == Skill);
            };
        }
