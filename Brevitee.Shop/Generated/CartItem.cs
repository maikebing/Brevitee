...
namespace Brevitee.Shop
{
	...
	[Brevitee.Data.Column(Name="Quantity", DbDataType="Int", MaxLength="4", AllowNull=false)]
	public int? Quantity
	{
		get
		{
	...
	public Cart CartOfCartId
	{
		get
		{
			...
			{
				_cartOfCartId = Brevitee.Shop.Cart.OneWhere(c => c.KeyColumn == this.CartId);
			}
	...
	public Item ItemOfItemId
	{
		get
		{
			...
			{
				_itemOfItemId = Brevitee.Shop.Item.OneWhere(c => c.KeyColumn == this.ItemId);
			}
