...
namespace Brevitee.Users.Data
{
    public partial class User
    {
        ...
        {
            User result = null;
            string userName = UserUtil.GetCurrentWebUserName();
        ...
        public void AddLoginRecord()
        {
            ...
            login.DateTime = System.DateTime.UtcNow;
            login.Save();
        }
        ...
        public string PasswordQuestion
        {
            ...
            set
            {
                Brevitee.Users.Data.PasswordQuestion q = PasswordQuestionsByUserId.JustOne();
                q.Value = value;
                q.Save();
            }
        }
        ...
        public static User Create(string userName, string email, string password, bool isApproved = true, bool createAccount = false, bool accountIsConfirmed = false)
        {
            ...
            if (createAccount)
            {
                Account.Create(user, DefaultConfiguration.GetAppSetting("ApplicationName", "UNKNOWN"), user.Id.Value.ToString(), accountIsConfirmed);
            }
        ...
        public static MembershipUser GetMembershipUser(User user)
        {
            ...
            EasyMembershipUser result = new EasyMembershipUser(
