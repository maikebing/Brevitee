...
namespace Brevitee.Server
{
    public class Scripts: ResponderBase
    {
        ...
        public string Templates()
        {
            ...
            Brevitee.Dust.Dust.Initialize();
            return Regex.Unescape(Brevitee.Dust.Dust.AllCompiledTemplates); //Dust.AllCompiledTemplates.Replace("\\\\\"", "\\\"");
        }
        ...
        private void GetCtorParamsAndBody(Type type, StringBuilder fkProto, out StringBuilder paramList, out StringBuilder body)
        {
            ...
            body.AppendFormat("\tthis.update = function(opts){{ Brevitee.{0}.update(this, opts); }};\r\n", varName);
            body.AppendFormat("\tthis.save = this.update;\r\n");
            body.AppendFormat("\tthis.delete = function(opts){{ Brevitee.{0}.delete(this, opts); }};\r\n", varName);
        ...
        private StringBuilder GetProxyScript(Incubator incubator, string[] classes)
        {
            ...
            stringBuilder.AppendLine("})(Brevitee, dao, jQuery, window || {});");
