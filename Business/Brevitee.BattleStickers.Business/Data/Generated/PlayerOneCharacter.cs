...
namespace Brevitee.BattleStickers.Business.Data
{
	...
	public Character CharacterOfCharacterId
	{
		...
		public static PlayerOneCharacterCollection LoadAll(Database database = null)
		{
			...
			Database db = database == null ? Db.For<PlayerOneCharacter>(): database;
		...
		{
			var results = new PlayerOneCharacterCollection(db, new Query<PlayerOneCharacterColumns, PlayerOneCharacter>(where, db), true);
			return results;
		}
		...
		{
			var results = new PlayerOneCharacterCollection(db, new Query<PlayerOneCharacterColumns, PlayerOneCharacter>(where, orderBy, db), true);
			return results;
		}
		...
		{
			var results = new PlayerOneCharacterCollection(db, Select<PlayerOneCharacterColumns>.From<PlayerOneCharacter>().Where(where, db));
			return results;
		}
