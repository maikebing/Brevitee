...
namespace Brevitee.BattleStickers.Business.Data
{
	...
	public SkillCollection SkillsByEffectOverTimeId
	{
		...
		public static EffectOverTimeCollection LoadAll(Database database = null)
		{
			...
			Database db = database == null ? Db.For<EffectOverTime>(): database;
		...
		{
			var results = new EffectOverTimeCollection(db, new Query<EffectOverTimeColumns, EffectOverTime>(where, db), true);
			return results;
		}
		...
		{
			var results = new EffectOverTimeCollection(db, new Query<EffectOverTimeColumns, EffectOverTime>(where, orderBy, db), true);
			return results;
		}
		...
		{
			var results = new EffectOverTimeCollection(db, Select<EffectOverTimeColumns>.From<EffectOverTime>().Where(where, db));
			return results;
		}
