...
namespace Brevitee.BattleStickers.Business.Data
{
	...
	public Skill SkillOfSkillId
	{
		...
		public static PlayerSkillCollection LoadAll(Database database = null)
		{
			...
			Database db = database == null ? Db.For<PlayerSkill>(): database;
		...
		{
			var results = new PlayerSkillCollection(db, new Query<PlayerSkillColumns, PlayerSkill>(where, db), true);
			return results;
		}
		...
		{
			var results = new PlayerSkillCollection(db, new Query<PlayerSkillColumns, PlayerSkill>(where, orderBy, db), true);
			return results;
		}
		...
		{
			var results = new PlayerSkillCollection(db, Select<PlayerSkillColumns>.From<PlayerSkill>().Where(where, db));
			return results;
		}
