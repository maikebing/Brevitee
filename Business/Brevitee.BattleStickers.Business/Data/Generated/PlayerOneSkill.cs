...
namespace Brevitee.BattleStickers.Business.Data
{
	...
	public Skill SkillOfSkillId
	{
		...
		public static PlayerOneSkillCollection LoadAll(Database database = null)
		{
			...
			Database db = database == null ? Db.For<PlayerOneSkill>(): database;
		...
		{
			var results = new PlayerOneSkillCollection(db, new Query<PlayerOneSkillColumns, PlayerOneSkill>(where, db), true);
			return results;
		}
		...
		{
			var results = new PlayerOneSkillCollection(db, new Query<PlayerOneSkillColumns, PlayerOneSkill>(where, orderBy, db), true);
			return results;
		}
		...
		{
			var results = new PlayerOneSkillCollection(db, Select<PlayerOneSkillColumns>.From<PlayerOneSkill>().Where(where, db));
			return results;
		}
