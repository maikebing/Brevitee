...
{
    public class EasyMembershipUser: MembershipUser
    {
        public EasyMembershipUser(
            string providerName,
            string name,
        ...
        public EasyMembershipUser(string providerName, string passwordQuestion, string comment, User user)
            : this(
            providerName, 
            user.UserName, 
            user.Id, 
