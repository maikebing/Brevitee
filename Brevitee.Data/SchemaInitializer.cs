    ...
    public class SchemaInitializer
    {
        ...
        public bool Initialize(ILogger logger, out Exception ex)
        {
            ...
            try
            {
                ...
                Args.ThrowIf<ArgumentException>(prop == null, "{0}.ConnectionName property was not found, make sure you're using the latest Brevitee.Data.Schema.dll", context.Name);                
