...
namespace Brevitee.BattleStickers.Business.Data
{
	...
	public Character CharacterOfCharacterId
	{
		...
		public static PlayerTwoCharacterHealthCollection LoadAll(Database database = null)
		{
			...
			Database db = database == null ? Db.For<PlayerTwoCharacterHealth>(): database;
		...
		{
			var results = new PlayerTwoCharacterHealthCollection(db, new Query<PlayerTwoCharacterHealthColumns, PlayerTwoCharacterHealth>(where, db), true);
			return results;
		}
		...
		{
			var results = new PlayerTwoCharacterHealthCollection(db, new Query<PlayerTwoCharacterHealthColumns, PlayerTwoCharacterHealth>(where, orderBy, db), true);
			return results;
		}
		...
		{
			var results = new PlayerTwoCharacterHealthCollection(db, Select<PlayerTwoCharacterHealthColumns>.From<PlayerTwoCharacterHealth>().Where(where, db));
			return results;
		}
