...
namespace Brevitee.BattleStickers.Business.Data
{
	...
	public PlayerTwoEquipmentCollection PlayerTwoEquipmentsByPlayerTwoId
	{
		...
		public static PlayerTwoCollection LoadAll(Database database = null)
		{
			...
			Database db = database == null ? Db.For<PlayerTwo>(): database;
		...
		{
			var results = new PlayerTwoCollection(db, new Query<PlayerTwoColumns, PlayerTwo>(where, db), true);
			return results;
		}
		...
		{
			var results = new PlayerTwoCollection(db, new Query<PlayerTwoColumns, PlayerTwo>(where, orderBy, db), true);
			return results;
		}
		...
		{
			var results = new PlayerTwoCollection(db, Select<PlayerTwoColumns>.From<PlayerTwo>().Where(where, db));
			return results;
		}
