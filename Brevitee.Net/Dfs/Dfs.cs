...
namespace Brevitee.Net
{
    public class Dfs
    {
        ...
        public static int Remove(string DfsEntryPath)
        {
            return Remove(DfsEntryPath, string.Empty, string.Empty);
        }

        public static int Remove(string DfsEntryPath, string targetServerName, string targetSharePath)
        {
        ...
        public static int Add(string DfsEntryPath, string targetUNC)
        {
            return Add(DfsEntryPath, targetUNC, "");
        }

        public static int Add(string DfsEntryPath, string targetUNC, string comment)
        {
            string[] splitted;
            string serverName;
            string pathName;
        ...
        public static int Remove(string DfsEntryPath, string targetUNC)
        {
            string[] splitted;
            string serverName;
            string pathName;
            ...
            return Remove(DfsEntryPath, serverName, pathName);
        }
