...
namespace Brevitee.Users.Data
{
	...
	[Brevitee.Data.Table("Password", "Users")]
	...
	// property:Salt, columnName:Salt	
	[Brevitee.Data.Column(Name="Salt", ExtractedType="", MaxLength="", AllowNull=false)]
	public string Salt
	{
		get
		{
			return GetStringValue("Salt");
		}
		set
		{
			SetValue("Salt", value);
	...
	// property:Sha1, columnName:Sha1	
	[Brevitee.Data.Column(Name="Sha1", ExtractedType="", MaxLength="", AllowNull=false)]
	public string Sha1
	{
		get
		{
			return GetStringValue("Sha1");
		}
		set
		{
			SetValue("Sha1", value);
