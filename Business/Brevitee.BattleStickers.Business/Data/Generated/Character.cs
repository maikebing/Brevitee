...
namespace Brevitee.BattleStickers.Business.Data
{
	...
	[Brevitee.Data.Column(Name="Defense", DbDataType="Int", MaxLength="4", AllowNull=false)]
	public int? Defense
	{
		get
		{
	...
	[Brevitee.Data.Column(Name="Speed", DbDataType="Int", MaxLength="4", AllowNull=false)]
	public int? Speed
	{
		get
		{
	...
	[Brevitee.Data.Column(Name="Magic", DbDataType="Int", MaxLength="4", AllowNull=false)]
	public int? Magic
	{
		get
		{
	...
	[Brevitee.Data.Column(Name="Acuracy", DbDataType="Int", MaxLength="4", AllowNull=false)]
	public int? Acuracy
	{
		get
		{
	...
	[Brevitee.Data.Column(Name="MaxHealth", DbDataType="Int", MaxLength="4", AllowNull=false)]
	...
	public RequiredLevelCharacterCollection RequiredLevelCharactersByCharacterId
	{
		...
		public static CharacterCollection LoadAll(Database database = null)
		{
			...
			Database db = database == null ? Db.For<Character>(): database;
		...
		{
			var results = new CharacterCollection(db, new Query<CharacterColumns, Character>(where, db), true);
			return results;
		}
		...
		{
			var results = new CharacterCollection(db, new Query<CharacterColumns, Character>(where, orderBy, db), true);
			return results;
		}
		...
		{
			var results = new CharacterCollection(db, Select<CharacterColumns>.From<Character>().Where(where, db));
			return results;
		}
