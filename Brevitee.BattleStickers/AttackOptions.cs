...
namespace Brevitee.BattleStickers
{
    public class AttackOptions
    {
        ...
        public AttackOptions()
        {
            ...
            {
                return (IAttackMethod)Brevitee.BattleStickers.Weapon.OneWhere(c => c.Id == Weapon);
            };
            this._attackMethodResolvers[AttackType.Spell] = () =>
            {
                return (IAttackMethod)Brevitee.BattleStickers.Spell.OneWhere(c => c.Id == Spell);
            };
            this._attackMethodResolvers[AttackType.Skill] = () =>
            {
                return (IAttackMethod)Brevitee.BattleStickers.Skill.OneWhere(c => c.Id == Skill);
            };
        }
